...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_root', type=str, default='./outputs_train')
    # parser.add_argument('--protein_root', type=str, default='./evaluation/pdb_data') # ./evaluation/pdb_data
